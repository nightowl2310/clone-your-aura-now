...
const CloneTuning = () => {
  ...
  const userId = "101"; // Replace with actual dynamic userId if needed
  ...
  const tuningOptions = [
    {
      ...
      icon: "📝",
      points: ["Understands fan sentiment", "Replies instantly in your tone"],
    ...
    },
    {
      ...
      icon: "📸",
      points: ["Engages via auto-replies", "Triggers based on keywords"],
    ...
    },
    {
      ...
      title: "Reply on DMs",
      icon: "💬",
      points: ["Handles frequent questions", "Learns from past chats"],
        ...
        <div className="p-6 max-w-7xl mx-auto">
          ...
          <div className="mt-8">
            ...
            <p className="text-muted-foreground mb-8">
              Customize how your AI clone interacts with your audience across
              different platforms.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {tuningOptions.map((option) => (
                <div
                  key={option.id}
                  onClick={() => navigate(option.route, { state: { userId } })}
                ...
                >
                  <Card className="h-full bg-[#1A1F2C] border-none rounded-2xl shadow-xl hover:shadow-2xl hover:shadow-[rgba(155,135,245,0.15)] hover:bg-[#232938] transition-all duration-300">
                    <CardContent className="p-6">
                      <div
                        className={`w-12 h-12 rounded-2xl flex items-center justify-center text-2xl mb-4 bg-gradient-to-br ${option.color} shadow-md`}
                      >
