          ...
          <table className="min-w-full border-collapse hidden md:table">
            <thead>
              <tr className="border-b border-border">
                ...
                <th className="pb-3 text-center">Live</th>
              </tr>
            </thead>
            <tbody>
              {automations.map((automation, index) => (
                <tr key={index} className="border-b border-border hover:bg-[#1A1F2C] transition-colors">
                  <td className="py-4 pl-4">{automation.name}</td>
                  <td className="py-4 text-center">{automation.type}</td>
